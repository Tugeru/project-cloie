...
ADD COLUMN     "term" "academic_term",
ADD COLUMN     "term_instance_id" UUID NOT NULL;

-- AlterTable
ALTER TABLE "course_bound_evaluations" DROP COLUMN "academic_year",
DROP COLUMN "semester",
DROP COLUMN "term",
ADD COLUMN     "course_assignment_id" UUID,
ADD COLUMN     "term_instance_id" UUID NOT NULL;
...
-- AlterTable
ALTER TABLE "student_academic_profiles" DROP COLUMN "academic_year",
DROP COLUMN "section",
...
-- CreateIndex
CREATE INDEX "course_bound_evaluations_term_instance_id_course_id_faculty_idx" ON "course_bound_evaluations"("term_instance_id", "course_id", "faculty_id", "section");
...
-- AddForeignKey
ALTER TABLE "course_bound_evaluations" ADD CONSTRAINT "course_bound_evaluations_term_instance_id_fkey" FOREIGN KEY ("term_instance_id") REFERENCES "academic_term_instances"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "central_deployments" ADD CONSTRAINT "central_deployments_term_instance_id_fkey" FOREIGN KEY ("term_instance_id") REFERENCES "academic_term_instances"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
