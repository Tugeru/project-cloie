      ...
      <div className="space-y-4 mt-auto">
        ...
        {isSelfService ? (
          ...
          >
            ...
            {isLoading ? "Connecting..." : `Sign in as ${config.title}`}
          </Button>
        ) : (
          <div className="w-full text-center py-2 text-sm text-text-muted bg-surface border border-border/50 rounded-md">
            {config.category === "provisioned_faculty" 
              ? "Account provisioned by your program head or admin"
