...
export type AdminProgramSummaryItem = {
  id: string;
  code: string;
  name: string;
...
export async function listAdminProgramsSummary(): Promise<{
  ...
  const programs: AdminProgramSummaryItem[] = rawPrograms.map((p) => {
