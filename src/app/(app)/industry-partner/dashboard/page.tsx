  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="space-y-1">
        <h1 className="text-heading-lg">Industry Partner Dashboard</h1>
              ...
              <Card key={item.assignmentId}>
                ...
                <CardContent className="flex items-center justify-between">
                  ...
                  <Button asChild size="sm" className="ml-auto font-bold">
                    <Link
                      href={`/industry-partner/evaluations/${item.deploymentId}`}
                    >
            ...
            {submitted.map((item) => (
              <Card key={item.assignmentId}>
                ...
                <CardContent className="flex items-center justify-between">
                  ...
                  >
                    <Link
                      href={`/industry-partner/evaluations/${item.deploymentId}/submitted`}
                    >
                      View Submission
                    </Link>
                  </Button>
